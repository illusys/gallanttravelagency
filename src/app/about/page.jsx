      ...
      <>
        ...
        <section id="ready_to_work_with_us" className="py-24 bg-primary relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
            ...
            <Link className="bg-cta hover:bg-white hover:text-cta text-white text-xl px-10 py-4 rounded-full font-bold transition-all shadow-xl inline-flex items-center gap-2" href="contact.html"> Start a Conversation </Link>
          </div>
        </section>
